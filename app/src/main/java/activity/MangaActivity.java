...
public class MangaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manga_activity_layout);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new OneFragment(), "Scans");
        adapter.addFragment(new TwoFragment(), "Chat");
        adapter.addFragment(new ThreeFragment(), "Historique");
